...
public class Buff {
	// Buff Class
	public Buff(int id, String name, String description, Consumer<Entity> funktion, boolean isDebuff, int interval,
			int duration, Entity entity) {
	...
	public Buff(int id, String name, String description, Consumer<Entity> funktion, Consumer<Entity> funktionOff,
			boolean isDebuff, int interval, int duration, Entity entity) {
		int existingBuffCount = 0;
	...
	private static ArrayList<Buff> allBuffs = new ArrayList<>();
	private static ArrayList<Buff> buffsToBeRemoved = new ArrayList<>();
