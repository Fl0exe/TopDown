...
// Constructor
	public Player(int x, int y, int hoehe, int breite, ZeichenFlaeche15 renderEngine, Kontrolle game) {
		super(x, y, hoehe, breite, new String[] {"Assets/Images/Player/amg1_bk1.png", "Assets/Images/Player/amg1_lf1.png", "Assets/Images/Player/amg1_rt1.png", "Assets/Images/Player/amg1_fr1.png"}, availableBehaviours.BEHAVE_NEUTRAL, 100, renderEngine, game);
	}
