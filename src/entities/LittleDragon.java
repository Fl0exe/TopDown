...
public class LittleDragon extends Entity {
	...
	public LittleDragon(int x, int y, int hoehe, int breite, ZeichenFlaeche15 renderEngine, Kontrolle game) {
		super(x, y, hoehe, breite, new String[] {"Assets/Images/Enemies/Dragon/dvl1_fr1.png", "Assets/Images/Enemies/Dragon/dvl1_bk1.png"}, availableBehaviours.BEHAVE_ENEMY, 1, renderEngine, game);
	}
	...
	public void move() {
		...
		if(behaviour instanceof Enemy) {
			...
			if(((Enemy) this.behaviour).getTargetPlayer() != null) {
				...
				Player targetPlayer = ((Enemy) this.behaviour).getTargetPlayer();
		...
		if(behaviour instanceof Friendly ) {
